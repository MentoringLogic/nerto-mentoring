...
{  
        ...
        {
        public BattleShip(string Name, List<PointStruct> points)
        {
        ...
        {
        public ServiceShip(string Name, List<PointStruct> points)
        {
            var Decks = new List<Deck>();
        ...
        {
        public HybridShip(string Name, List<PointStruct> points)
        {
            var Decks = new List<Deck>();
